const quizDataNine = [
    {
      ...
      Answer: "To trigger side effects in function components",
    ...
    },
    {
      ...
      Answer: "Only when the component unmounts",
    ...
    },
    {
      ...
      Answer: "By passing an empty array `[]` as the second argument",
    ...
    },
    {
      ...
      Answer: "Performing side effects like fetching data or DOM manipulation",
    ...
    },
    {
      ...
      Answer: "It cleans up resources like event listeners or intervals when the component unmounts or updates",
    ...
    },
    {
      ...
      Answer: "The effect runs once after the initial render",
    ...
    },
    {
      ...
      Answer: "By passing a list of state or props in the dependency array",
    ...
    },
    {
      ...
      Answer: "Yes, it can return a cleanup function to remove resources",
